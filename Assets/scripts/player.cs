...
public class Player : MonoBehaviour,IKitchenOtjectParent
{
    ...
    {
        if (!KitchenGameMangar.Instance.IsGamePlaying()) return;
    ...
    private void HandlOInteractions()
    {
    ...
    private void HandleMovement()
    {
        ...
        if (!canMove)
        {
            //Cannt move towred moveDir

            //Attempt onlye x movement
